...
#
#     rules = (
#         Rule(LinkExtractor(allow='',restrict_xpaths=('//*[@class="position_link"]')), callback='parse_item'),
#         # Rule(LinkExtractor(restrict_xpaths=('//*[@class="pager_container"]/a[last()]')))
#     )
#
