...
'https://www.lagou.com/zhaopin/youxipeilian/',]
    ...
    def parse(self, response):
        item = LagouItem()
        item["job_name"] = response.xpath('/html/body/div[7]/div/div[1]/div/h1/text()').extract_first()
        item["salary"] = response.xpath('/html/body/div[7]/div/div[1]/dd/h3/span[1]/text()').extract_first()
        item["place"] = response.xpath('/html/body/div[7]/div/div[1]/dd/h3/span[2]/text()').extract_first()
        item["experience"] = response.xpath('/html/body/div[7]/div/div[1]/dd/h3/span[3]/text()').extract_first()
        item["degree"] = response.xpath('/html/body/div[7]/div/div[1]/dd/h3/span[4]/text()').extract_first()
        item["category"] = response.xpath('/html/body/div[7]/div/div[1]/dd/h3/span[5]/text()').extract_first()
        item["update_time"] = response.xpath('/html/body/div[7]/div/div[1]/dd/p/text()').extract_first()
